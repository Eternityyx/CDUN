...
if __name__ == "__main__":
    ...
    savemat_val_data_name = f'../../disk3/xmm/{NET}/WV3_{condition}_val_data.mat'
    savenet_data_name = checkpoint + f'/{{}}_WV3_new_{condition}_{{}}.pth'
    ...
    for i in range(1, epoch + 1):
        ...
        if (i) % 2 == 0:
            ...
            psnr, sam, ergas, loss = validation(validation_dataloader)
            validRecord["epoch"].append(i)
            validRecord["LOSS"].append(loss.item())
